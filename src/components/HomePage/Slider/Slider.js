...
{
	/* <img src="./assets/images/main-slider/3-1.jpg" alt=""/> */
}
function Slider() {
	return (
			...
			<div id="slider3" class="rev_slider fullwidthabanner" data-version="5.4.1">
				<ul>
					...
					<li
						...
						data-thumb="slider-3/3-1-100x50.jpg"
						data-rotate="0"
					...
					>
						{/* <!-- MAIN IMAGE --> */}
						<img
							src="assets/images/main-slider/3-1.jpg"
							alt=""
							title="Home Page 3"
					...
					>
						{/* <!-- MAIN IMAGE --> */}
						<img
							src="assets/images/main-slider/3-3.jpg"
							alt=""
							title="Home Page 3"
							data-bgposition="center center"
							data-bgfit="cover"
